      ...
      <main className="lg:relative">
        <div className="mx-auto w-full max-w-7xl pt-16 pb-5 md:pb-20 text-center lg:py-48 lg:text-left">
          <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
            ...
            For creative entrepreneurs and growing brands who do business outside the box. We&apos;re a network of creative professionals, technologists and strategists dedicated to helping you grow – and look good while you do it.
            </p>
