...
export default function MainPage2() {
  return (
    <div className="relative overflow-hidden bg-gray-50">
      ...
      <div className="mt-32 mb-64 relative pt-6 pb-16 sm:pb-24">
        {/* <Popover>
          ...
          <div className="text-center">
            ...
            <div className="mx-auto mt-5 max-w-md sm:flex sm:justify-center md:mt-8">
              <div className="rounded-md shadow">
                <a
                  href="#"
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-black px-8 py-3 text-base font-medium text-white hover:bg-[#ffc800ff] hover:text-black md:py-4 md:px-10 md:text-lg"
                >
                  Get Access
                </a>
              </div>
